...
\end{ejercicio}
Pruebe que los tres grafos de Petersen son isomorfos:
\\\\
\textbf{Solución.} 
\\\\
A continuaciòn se mostraràn los grafos con los vèrtices enumerados, donde 2 vertices con el mismo numero indican una correspondencia entre tales vertices de los grafos.
\begin{center}
\begin{tikzpicture}
  %-- nodos, template de elizabeth xd
  \node (1) [draw,circle,inner sep=2pt,fill] at (0,0) {};
  \node (ta) [font=\fontsize{11}{0}\selectfont] at (0,0.3) {1};
  
  \node (2) [draw,circle,inner sep=2pt,fill] at (-2,-2) {};
  \node (tb) [font=\fontsize{11}{0}\selectfont] at (-2,-2.3) {2};
  
  \node (3) [draw,circle,inner sep=2pt,fill] at (2,-2) {};
  \node (tc) [font=\fontsize{11}{0}\selectfont] at (2,-2.3) {3};
  
  \node (4) [draw,circle,inner sep=2pt,fill] at (0,-1) {};
  \node (td) [font=\fontsize{11}{0}\selectfont] at (0,-0.7) {4};
  
  \node (5) [draw,circle,inner sep=2pt,fill] at (1,-4) {};
  \node (te) [font=\fontsize{11}{0}\selectfont] at (1,-4.3) {5};
  
   \node (6) [draw,circle,inner sep=2pt,fill] at (1,-2) {};
  \node (te) [font=\fontsize{11}{0}\selectfont] at (1,-2.3) {6};
  
   \node (7) [draw,circle,inner sep=2pt,fill] at (-1,-4) {};
  \node (te) [font=\fontsize{11}{0}\selectfont] at (-1,-4.3) {7};
  
   \node (8) [draw,circle,inner sep=2pt,fill] at (-0.5,-3) {};
  \node (te) [font=\fontsize{11}{0}\selectfont] at (-0.5,-3.3) {8};
  
   \node (9) [draw,circle,inner sep=2pt,fill] at (0.5,-3) {};
  \node (te) [font=\fontsize{11}{0}\selectfont] at (0.5,-3.3) {9};
  
   \node (10) [draw,circle,inner sep=2pt,fill] at (-1,-2) {};
  \node (te) [font=\fontsize{11}{0}\selectfont] at (-1,-2.3) {10};
...
\begin{tikzpicture}
  %-- nodos, template de elizabeth xd
  \node (1) [draw,circle,inner sep=2pt,fill] at (0,-2) {};
  \node (ta) [font=\fontsize{11}{0}\selectfont] at (0,-2.3) {1};
  
  \node (2) [draw,circle,inner sep=2pt,fill] at (-1,-3) {};
  \node (tb) [font=\fontsize{11}{0}\selectfont] at (-1,-3.3) {2};
  
  \node (3) [draw,circle,inner sep=2pt,fill] at (0,-1) {};
  \node (tc) [font=\fontsize{11}{0}\selectfont] at (0,-0.7) {3};
  
  \node (4) [draw,circle,inner sep=2pt,fill] at (1,-3) {};
  \node (td) [font=\fontsize{11}{0}\selectfont] at (1,-3.3) {4};
  
  \node (5) [draw,circle,inner sep=2pt,fill] at (-2,-2) {};
  \node (te) [font=\fontsize{11}{0}\selectfont] at (-2,-2.3) {5};
  
   \node (6) [draw,circle,inner sep=2pt,fill] at (2,-2) {};
  \node (te) [font=\fontsize{11}{0}\selectfont] at (2,-2.3) {6};
  
   \node (7) [draw,circle,inner sep=2pt,fill] at (-1,0) {};
  \node (te) [font=\fontsize{11}{0}\selectfont] at (-1,0.3) {7};
  
   \node (8) [draw,circle,inner sep=2pt,fill] at (1,0) {};
  \node (te) [font=\fontsize{11}{0}\selectfont] at (1,0.3) {8};
  
   \node (9) [draw,circle,inner sep=2pt,fill] at (-1,-4) {};
  \node (te) [font=\fontsize{11}{0}\selectfont] at (-1,-4.3) {9};
  
   \node (10) [draw,circle,inner sep=2pt,fill] at (1,-4) {};
  \node (te) [font=\fontsize{11}{0}\selectfont] at (1,-4.3) {10};
...
\begin{tikzpicture}
  %-- nodos, template de elizabeth xd
  \node (1) [draw,circle,inner sep=2pt,fill] at (0,-2.5) {};
  \node (ta) [font=\fontsize{11}{0}\selectfont] at (0,-2.76) {1};
  
  \node (2) [draw,circle,inner sep=2pt,fill] at (-1.5,-3) {};
  \node (tb) [font=\fontsize{11}{0}\selectfont] at (-1.5,-3.3) {2};
  
  \node (3) [draw,circle,inner sep=2pt,fill] at (0,0) {};
  \node (tc) [font=\fontsize{11}{0}\selectfont] at (0,0.3) {3};
  
  \node (4) [draw,circle,inner sep=2pt,fill] at (1.5,-3) {};
  \node (td) [font=\fontsize{11}{0}\selectfont] at (1.5,-3.3) {4};
  
  \node (5) [draw,circle,inner sep=2pt,fill] at (-1,0) {};
  \node (te) [font=\fontsize{11}{0}\selectfont] at (-1,0.3) {5};
  
   \node (6) [draw,circle,inner sep=2pt,fill] at (1,0) {};
  \node (te) [font=\fontsize{11}{0}\selectfont] at (1,0.3) {6};
  
   \node (7) [draw,circle,inner sep=2pt,fill] at (-1.5,-1) {};
  \node (te) [font=\fontsize{11}{0}\selectfont] at (-1.5,-1.3) {7};
  
   \node (8) [draw,circle,inner sep=2pt,fill] at (1.5,-1) {};
  \node (te) [font=\fontsize{11}{0}\selectfont] at (1.5,-1.3) {8};
